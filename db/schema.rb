...
ActiveRecord::Schema.define(version: 20150914162739) do
  ...
  add_index "transactions", ["action_type", "action_id"], name: "index_transactions_on_action_type_and_action_id", using: :btree
